...
try {
  ...
  assert.deepEqual(result, { states: ["idle", "calibrating", "countdown", "playing", "paused_tracking", "paused_tracking", "countdown"], recoverySequence: [3, 2, 2, 1, "playing"], frozen: true, serializable: "browser", countdownReason: "tracking_resume", malformedFlowRejected: true, malformedFlowTransactional: true, ignoredFlowResults: [["browser-bomb", "ignored"], ["browser-arc", "ignored"], ["browser-burst", "ignored"]], visualProfile: "aero.visual.compact", scoringProfile: "aero.scoring.prototype-wide", regenerationRequired: true, bundleHash: "sha256:81df0fa01910c08bac660c036be23a1ac1bf3f0e8f62ad3355b9e8362b20ae37" });
